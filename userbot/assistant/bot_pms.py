    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"Hey! 👤{mention},\
                        ...
                        \n\nPowered by [LUXCLUB](https://t.me/LUXCLUB_SERGIO)"
        buttons = [
            (
                Button.url("CHAT GROUP", "https://t.me/LUXCLUB_SERGIO),
                Button.url(
                    "CHANNEL",
                    "https://t.me/LUCIFER_908888",
                ),
            )
        ]
    else:
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if user_id is not None:
            try:
                ...
                return await event.reply("𝗧𝗵𝗶𝘀 𝗯𝗼𝘁 𝘄𝗮𝘀 𝗯𝗹𝗼𝗰𝗸𝗲𝗱 𝗯𝘆 𝘁𝗵𝗲 𝘂𝘀𝗲𝗿. ⚠︎")
            except Exception as e:
