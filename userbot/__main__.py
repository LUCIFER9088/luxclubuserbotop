...
async def hehn():
    try:
        await lionub(JoinChannelRequest("@LionXKangUsersGroup"))
...
async def startup_process():
    ...
    print("➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖")
    print("Yay your LUXCLUB Userbot is officially working, Now Gib Party Kiddo..!!!")
    print(
        f"Congratulation, now type {cmdhr}alive to see message if lionub is live\
        \nIf you need assistance, head to https://t.me/LUXCLUB_SERGIO"
    )
    print("➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖➖")
    await verifyLoggerGroup()
