...
@lionub.lion_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [LUXCLUB]<buttonurl:https://t.me/LUXCLUB_SERGIO:same> [support]<buttonurl:https://t.me/LUXCLUB_SERGIO>",
    },
)
async def _(event):
...
@lionub.lion_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [LUXCLUB]<buttonurl:https://t.me/LUXCLUB_SERGIO:same> [support]<buttonurl:https://t.me/LUXCLUB_SERGIO>",
    },
)
async def _(event):
